...
* userId 1..1 string "The id of the current user. Must be in the format [ResourceType]/[id]." "For this hook, the user is expected to be of type Practitioner or PractitionerRole. For example, Practitioner/abc."
* userId obeys ord-1
